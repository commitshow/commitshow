...
- **미국 런칭**, 법인 (Delaware C-Corp · Stripe Atlas) 설립 완료
...
- Creator 첫 3 Commits 무료 · 4번째부터 $99/Commit (CA Penal §319 Lottery 회피 3축 안전판 §17)
...
첫 3회 무료 Creator:
  환급 개념 없음 (원래 낸 돈 없음)
  나머지 혜택 (상금·졸업 배지·노출·Hall of Fame) 동일 수령
```
...
- 결제: Stripe (단일 $99 세션 · 법무상 $20 Contest Fee + $79 Refundable Deposit 로 장부 분리 §17)
- 페이아웃 레일: Wise Business (1사분) / Trolley (2사분 백엔드)
- 미국인: W-9 · 외국인 개인: W-8BEN · 법인: W-8BEN-E 수령 후 지급
- OFAC 제재 심사 통과 필수
...
Phase A (V1 런칭 · 초기 안정화 단계):
  ...
  보상: 시즌당 $500 우승 상금 (베타 Season Zero·1 은 $200 로 다운사이징)
  전환 지표 (Phase B 전환 조건):
    ☐ 누적 앱 등록 100+
    ☐ MAU 5,000+
...
Phase B (매주 롤링 · 성숙기):
  ...
  보상: 시즌당 $500 상금 × 월 4 리그 = 월 $2,000 상금 풀
```
...
Day 29:             Graduation Day · 환급 지급 · 배지 · 상금 ($500 Valedictorian)
...
V1 (결제·공유·직접 업로드)
  ☐ Stripe 결제 flow (V1 런칭 필수 · $99 등록비와 같이 배포)
...
결제·OAuth (P7 · V1 런칭 필수)
  ...
  ☐ Stripe 결제 flow (등록비 $99 + Library 유료 tier)
...
리그 종료 엔진 (P8 · 크론 최후 정책 · V1 끝)
  ...
  ☐ Creator 환급 페이아웃 (Wise Business · W-9/W-8BEN)
...
> **민감 정보 — 비공개 처리 (2026-04-28).** Counsel 확인 사항, 통계법·계약법 · 1099 ·
> Lottery 회피 노트 등은 **`INTERNAL.md` §2** 참조.
...
10. 브랜드 verb (v2 · §1-A ⑥ 업데이트 2026-04-24)
    ...
    - "$99 application/entry fee" → "$99 audition fee"
...
P7 · 결제·OAuth (V1 런칭 필수)
  ...
  Stripe 결제 flow ($99 audition fee + Library 유료)
